...
export default function AboutUs(){
    ...
    <div>
        ...
        <div style={{display:'flex', justifyContent:useMediaQuery('(max-width: 600px)')?'center':'flex-start', marginTop:75}}>
            ...
            <img src="/aboutuspic1.png" width={'8%'} height={'2%'} style={{alignSelf:'center', justifySelf:'center', marginLeft:'22vw', display:useMediaQuery('(max-width: 600px)')?'none':'block'}} className='aboutuspic1' alt='' />
        </div>
        <div style={{display:'flex', justifyContent: useMediaQuery('(max-width: 600px)')?'center':'flex-end', marginTop: useMediaQuery('(max-width: 600px)')?50:40}}>
            <img src="/aboutuspic2.png" width={'15%'} height={'5%'} style={{alignSelf:'center', justifySelf:'center', marginRight:'22vw', display:useMediaQuery('(max-width: 600px)')?'none':'block'}} className='aboutuspic2' alt='' />
